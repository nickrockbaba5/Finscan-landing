        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-400 leading-relaxed">
                We use the information we collect to provide, maintain, and improve our services, to communicate with you, and to protect FinScan and our users.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-400 leading-relaxed">
                You have the right to access, update, or delete your personal information. You may also have the right to object to or restrict certain types of processing.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-400 leading-relaxed">
                ...
                <a href="mailto:privacy@finscan.uk" className="text-gray-300 hover:text-white underline">
                  privacy@finscan.uk
                </a>
              </p>
            </section>
